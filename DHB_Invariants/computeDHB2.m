...
function [linear_motion_invariant, angular_motion_invariant, linear_frame_initial, angular_frame_initial] = computeDHB2(position_diff, rotation_diff, method, initial_pose)
...
linear_frame_y = computeFrameAxisY(linear_frame_x, linear_frame_x2, [linear_frame_x(2)-linear_frame_x(3), linear_frame_x(3)-linear_frame_x(1), linear_frame_x(1)-linear_frame_x(2)]/norm([linear_frame_x(2)-linear_frame_x(3), linear_frame_x(3)-linear_frame_x(1), linear_frame_x(1)-linear_frame_x(2)]));
...
% added by ANDY
% if(strcmp(method, 'pos'))
%     angular_frame_initial(1:3,1:3) = angular_frame_initial(1:3,1:3);
% end
