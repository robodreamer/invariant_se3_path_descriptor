...
sig2w_mu = 1e-4;
% hyp_var = [10.0, 1/4, 10.0]; % [gain/length/alpha] worse
hyp_var = [10.0, 0.8, 10.0]; % [gain/length/alpha] better
% hyp_var = [10.0, 1.0, 10.0]; % [gain/length/alpha] ok
